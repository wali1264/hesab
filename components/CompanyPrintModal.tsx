                ...
                <div className="flex-1 overflow-y-auto p-8 bg-slate-100/50 print:p-0 print:bg-white print:overflow-visible">
                        <style dangerouslySetInnerHTML={{ __html: `
                            @media print {
                                ...
                                .print-title { font-size: 38pt !important; margin-bottom: 2mm !important; }
                                .print-subtitle { font-size: 16pt !important; }
                                .print-header-title { font-size: 32pt !important; margin: 4mm 0 !important; }
                                .print-metadata { font-size: 20pt !important; font-weight: 950 !important; color: #000 !important; }
                                .print-metadata span { font-size: 20pt !important; }
                                .print-label { font-size: 18pt !important; font-weight: 950 !important; color: #000 !important; opacity: 0.8; }
                                .print-customer-name { font-size: 34pt !important; font-weight: 950 !important; margin: 3mm 0 !important; }
                                .print-customer-code { font-size: 24pt !important; font-weight: 950 !important; }
                                .print-item-title { font-size: 32pt !important; font-weight: 950 !important; }
                                .print-readings { font-size: 26pt !important; font-weight: 950 !important; color: #000 !important; margin-top: 6mm !important; border: 3px solid #000; padding: 4mm 8mm; border-radius: 6px; display: inline-block; width: 100%; max-width: 16cm; }
                                .print-unit-row { font-size: 30pt !important; font-weight: 950 !important; margin-top: 4mm !important; }
                                .print-fee-info { font-size: 18pt !important; font-weight: 950 !important; color: #000 !important; }
                                .print-total-label { font-size: 24pt !important; font-weight: 950 !important; color: #000 !important; margin-bottom: 2mm !important; }
                                .print-amount-big { font-size: 90pt !important; line-height: 1 !important; margin: 15mm 0 !important; font-weight: 950 !important; }
                                .print-amount-words { font-size: 22pt !important; font-weight: 950 !important; color: #000 !important; display: inline-block; width: 100%; max-width: 16cm; overflow-wrap: break-word; }
                                .print-status-stamp { font-size: 48pt !important; padding: 6mm 15mm !important; border-width: 6px !important; font-weight: 950 !important; margin: 5mm 0 !important; }
                                .print-registrar-box { font-size: 20pt !important; font-weight: 950 !important; }
                                .print-footer-text { font-size: 22pt !important; font-weight: 950 !important; color: #000 !important; margin: 5mm 0 !important; }
                                .print-contact-info { font-size: 18pt !important; font-weight: 950 !important; color: #000 !important; }
                            }
                        ` }} />
                        ...
                        <div className="printable-area bg-white mx-auto p-[2mm] rounded-sm w-full max-w-[21cm] text-slate-900 print:p-[2mm] print:m-0 print:w-full print:max-w-none print:min-h-0 font-sans text-center" dir="rtl" style={{ minHeight: '100%' }}>
                            ...
                            <div className="mb-2 mt-4 print:mt-10">
                            ...
                            <div className="mb-4 space-y-0">
                                ...
                                <div className="text-[10px] font-bold space-y-2 mt-2 print-metadata">
                            ...
                            <div className="pt-4 border-t-2 border-dashed border-slate-900 print:mt-10">
                                <p className="text-xs font-black mb-3 print-footer-text">
