                                                ...
                                                <div className="col-span-2 md:col-span-1 flex items-end gap-2">
                                                    ...
                                                    <div className="relative">
                                                        <button 
                                                            ...
                                                            className={`h-12 w-8 flex items-center justify-center rounded-lg border transition-all ${item.companyId ? 'bg-blue-50 border-blue-200 text-blue-600' : 'bg-slate-50 border-slate-200 text-slate-400 hover:bg-slate-100'}`}
                                                            title="انتخاب کمپانی"
                                                        >
                                                            <ChevronDownIcon className={`w-4 h-4 transition-transform ${activeCompanySelectIndex === index ? 'rotate-180' : ''}`} />
                                                        </button>
                                                                    ...
                                                                    {companies.length === 0 ? (
                                                                        ...
                                                                        companies.map(c => (
                                                                            <button
                                                                                ...
                                                                                className={`w-full text-right p-2 rounded-lg text-xs font-bold transition-colors flex items-center justify-between ${item.companyId === c.id ? 'bg-blue-50 text-blue-700' : 'hover:bg-slate-50 text-slate-600'}`}
                                                                            >
                                                                                <span>{c.name}</span>
                                                                                {item.companyId === c.id && <BuildingIcon className="w-3 h-3" />}
                                                                            </button>
                                                                        ))
                                                                    )}
                                                                </div>
